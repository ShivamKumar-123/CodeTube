...
import { DSACoursesData } from "../assets/data.js";
...
function DSACourses() {
  ...
  const filteredCourses = DSACoursesData.filter((course) => {
    const matchesSearch =
  ...
  const floatingIcons = [
    { Icon: Code2,     x: "8%",  y: "18%", delay: 0,   color: "text-red-500/20",    size: 52 },
    { Icon: GitBranch, x: "88%", y: "12%", delay: 0.6, color: "text-yellow-400/20", size: 44 },
    { Icon: ListTree,  x: "80%", y: "65%", delay: 1.2, color: "text-sky-400/20",    size: 48 },
    { Icon: Network,   x: "4%",  y: "72%", delay: 1.8, color: "text-yellow-400/20", size: 40 },
    { Icon: Brackets,  x: "48%", y: "88%", delay: 2.4, color: "text-red-500/20",    size: 36 },
    { Icon: GitBranch, x: "30%", y: "5%",  delay: 0.3, color: "text-sky-400/15",    size: 32 },
  ];

  const stats = [
    { value: `${DSACoursesData.length}+`, label: "Courses",   color: "from-red-500 to-red-400"                },
    { value: "2",                          label: "Languages", color: "from-yellow-400 to-yellow-300"          },
    { value: "Free",                       label: "Access",    color: "from-sky-400 to-sky-300"                },
    { value: "DSA",                        label: "Focused",   color: "from-red-500 via-yellow-400 to-sky-400" },
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-20 pb-12 text-center">
        ...
        >
          <div className="relative">
            ...
            <motion.div
              className="absolute rounded-2xl border-2 border-dashed border-yellow-400/40"
              style={{ inset: "-6px" }}
              animate={{ rotate: 360 }}
              transition={{ duration: 12, repeat: Infinity, ease: "linear" }}
            />
            {/* Icon Box */}
            <div className="w-20 h-20 bg-gradient-to-br from-red-500 via-yellow-400 to-sky-400 rounded-2xl flex items-center justify-center shadow-2xl shadow-yellow-400/30 relative z-10">
        ...
        >
          ...
          <br />
          <span className="bg-gradient-to-r from-yellow-400 via-red-500 to-sky-400 bg-clip-text text-transparent">
            Algorithms
          </span>
        </motion.h1>
        ...
        >
          Strengthen your problem-solving skills with structured DSA courses
        ...
        >
          ...
          <div className="relative mb-4">
            ...
            <motion.input
              type="text"
              placeholder="Search DSA courses..."
              value={searchQuery}
              ...
              <motion.button
                ...
                className={`px-5 py-2 rounded-full text-sm font-semibold border-2 transition-all duration-300 ${
                  activeFilter === filter.key
                    ? "border-yellow-400 bg-yellow-400/20 text-yellow-300 shadow-lg shadow-yellow-400/20"
        ...
        {filteredCourses.length > 0 ? (
          ...
          >
            ...
            <motion.button
              ...
              className="px-6 py-2.5 rounded-full border-2 border-yellow-400 text-yellow-400 text-sm font-semibold hover:bg-yellow-400/10 transition-all duration-300"
